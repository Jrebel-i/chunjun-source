...
public class Launcher {
    ...
    public static final String KEY_FLINKX_HOME = "/mnt1/module/chunjun-dist/chunjun";
    public static final String KEY_FLINK_HOME = "/mnt1/module/flink-1.12.7";//编译时会校验，不要添加注释在后面目前只支持   1.12.x版本
    public static final String KEY_HADOOP_HOME = "/usr/lib/hadoop";
